const moduleRegistry = [
  { key: "dashboard", label: "首页", section: "运营总览", permission: "dashboard:view" },
  { key: "productionConfig", label: "生产配置", section: "基础主数据", permission: "production_config:view" },
  { key: "customer", label: "客户管理", section: "基础主数据", permission: "customer:view" },
  { key: "process", label: "工艺管理", section: "基础主数据", permission: "process:view" },
  { key: "barcode", label: "条码管理", section: "执行与采集", permission: "barcode:view" },
  { key: "production", label: "生产管理", section: "执行与采集", permission: "work_order:view" },
  { key: "equipment", label: "设备管理", section: "执行与采集", permission: "equipment:view" },
  { key: "warehouse", label: "仓库管理", section: "物流协同", permission: "warehouse:view" },
  { key: "traceability", label: "履历追溯", section: "质量闭环", permission: "trace:view" },
  { key: "reports", label: "统计报表", section: "质量闭环", permission: "report:view" },
  { key: "approval", label: "审批管理", section: "组织协同", permission: "approval:view" },
  { key: "settings", label: "系统设置", section: "组织协同", permission: "settings:view" }
];

const permissions = [
  { code: "dashboard:view", name: "查看首页看板", module: "dashboard" },
  { code: "production_config:view", name: "查看生产配置", module: "productionConfig" },
  { code: "customer:view", name: "查看客户管理", module: "customer" },
  { code: "process:view", name: "查看工艺管理", module: "process" },
  { code: "barcode:view", name: "查看条码规则", module: "barcode" },
  { code: "barcode:issue", name: "签发条码", module: "barcode" },
  { code: "work_order:view", name: "查看工单", module: "production" },
  { code: "work_order:update", name: "更新工单状态", module: "production" },
  { code: "equipment:view", name: "查看设备", module: "equipment" },
  { code: "warehouse:view", name: "查看仓库", module: "warehouse" },
  { code: "trace:view", name: "查看追溯", module: "traceability" },
  { code: "report:view", name: "查看报表", module: "reports" },
  { code: "approval:view", name: "查看审批", module: "approval" },
  { code: "approval:decision", name: "处理审批", module: "approval" },
  { code: "settings:view", name: "查看系统设置", module: "settings" },
  { code: "settings:update", name: "修改系统设置", module: "settings" },
  { code: "user:view", name: "查看用户权限", module: "settings" }
];

const allPermissionCodes = permissions.map((item) => item.code);

const roles = [
  { code: "super_admin", name: "系统管理员", permissionCodes: allPermissionCodes },
  {
    code: "planner",
    name: "生产计划员",
    permissionCodes: [
  ...
  barcodeRules: [
    {
      ...
      ruleCode: "barcode-sn",
      rule: "整机 SN 规则",
      sample: "SN-YYMMDD-LINE-XXXX",
      printer: "ZT410-A",
      queue: 126,
      success: "99.6%",
      lastSync: "2026-04-18 12:48"
    },
    {
      id: "BAR-RULE-002",
      ruleCode: "barcode-box",
      rule: "半成品箱码",
      sample: "BX-LOT-SEQ",
      printer: "CL4NX",
      queue: 84,
      success: "99.1%",
      lastSync: "2026-04-18 12:36"
    },
    {
      id: "BAR-RULE-003",
      ruleCode: "barcode-station",
      rule: "工位追溯码",
      sample: "ST-ORDER-STEP",
      printer: "ZT230",
      queue: 216,
      success: "98.8%",
      lastSync: "2026-04-18 12:41"
    }
  ],
  barcodeIssuances: [
    {
      id: "BC-0001",
      ruleCode: "barcode-sn",
      workOrderId: "WO-260418-002",
      value: "SN-260418-SMT01-0086",
      station: "AOI-02",
      operator: "李雪",
    ...
    },
    {
      ...
      value: "BX-20260418-031",
      station: "PACK-01",
      operator: "周婷",
      createdAt: "2026-04-18 11:26"
    }
  ],
  workOrders: [
    {
      ...
      productCode: "PROD-001",
      line: "SMT-01",
      lineCode: "LINE-SMT-01",
      routeCode: "ROUTE-FCT-01",
      factoryCode: "FAC-001",
      planned: 1200,
      produced: 860,
      passRate: 98.6,
    ...
    },
    {
      ...
      productCode: "PROD-002",
      line: "SMT-02",
      lineCode: "LINE-SMT-02",
      routeCode: "ROUTE-PCBA-03",
      factoryCode: "FAC-001",
      planned: 2400,
      produced: 2140,
      passRate: 99.2,
    ...
    },
    {
      ...
      productCode: "PROD-003",
      line: "ASSY-03",
      lineCode: "LINE-ASSY-03",
      routeCode: "ROUTE-ASSY-08",
      factoryCode: "FAC-002",
      planned: 180,
      produced: 108,
      passRate: 97.1,
